...
if __name__ == '__main__':
    ...
    def objective(trial):
        ...
        for train_index, test_index in kf.split(index):
            ...
            print("psnr all epochs :", psnr_test_metric)
            print("Values type :", type(psnr_test_metric[0][0]))
            print("\nMax psnr for this fold :", max(psnr_test_metric["psnr"]))
            index_best_epoch = psnr_test_metric["psnr"].index(max(psnr_test_metric["psnr"][0]))
            index_best_epoch_bpnn = bpnn_test_metric["BPNN"].index(max(bpnn_test_metric["BPNN"][0]))
